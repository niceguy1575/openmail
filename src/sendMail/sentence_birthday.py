...
if __name__ == "__main__":
	...
	# 생일 관련 메세지를 출력
	sentence,sentence2 = sentence_birthday(key_df.yourmap_notion_api_key[0])
	
	# 이메일을 포함한 연구원들의 메타데이터를 추출
	get_meta(key_df.yourmap_notion_api_key[0])
